...
class eleven_all(datasets.imdb):
    def __init__(self, image_set, devkit_path):
        print('===> Start eleven_all.__init__')

        datasets.imdb.__init__(self, 'eleven_all_' + image_set)        
        ...
        print('===> Start eleven_all.__init__. done')
    ...
    def _load_image_set_index(self):
        print('===> Start eleven_all._load_image_set_index')
        """
    ...
    def gt_roidb(self):
        ...
        """
        print('===> Start eleven_all.get_oridb')
        ...
        gt_roidb = self._load_11st_all_annotation()

        with open(cache_file, 'wb') as fid:
            cPickle.dump(gt_roidb, fid, cPickle.HIGHEST_PROTOCOL)
        print 'wrote gt roidb to {}'.format(cache_file)

        print('===> Start eleven_all.get_oridb. done')
        return gt_roidb

    def _load_11st_all_annotation(self):
        """
        Load image and bounding boxes info from annotation txt in the 11st DB
        """
        print('===> Start eleven_all._load_11st_all_annotation')
        gt_roidb = []

        filename = os.path.join(self._data_path, 'Annotations', 'annotations_' + self._image_set + '.txt')
        #filename = os.path.join(self._data_path, 'Annotations', 'annotations.txt')
        ...
        print('===> Start eleven_all._load_11st_all_annotation. done')
        return gt_roidb
    ...
    def selective_search_roidb(self):
        ...
        This function loads/saves from/to a cache file to speed up future calls.
        """
        print('===> Start eleven_all.selective_search_roidb')
        ...
        print('===> Start eleven_all.selective_search_roidb. done')
        return roidb
...
if __name__ == '__main__':
    d = eleven_all('train', '/storage/product/detection/11st_All/')
    res = d.roidb
